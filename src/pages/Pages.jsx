              ...
              <section className="mt-5">
                ...
                <div className="flex flex-col gap-y-6">
                  <div>
                    <div className="overflow-hidden w-full border border-gray-400 rounded-md bg-white">
                      <div className="px-3 py-2">
                        <p className="font-bold">Advanced Blocks</p>
                        <p>Special blocks in Feather.</p>
                      </div>
                      ...
                      <div className="w-full h-36 overflow-scroll">
                          ...
                          <div className="">
                            <div className="grid grid-cols-2 items-center px-3 py-2">
                              <div className="flex items-center space-x-2">
                                <h5 className="font-semibold">Hero Block</h5>
                                <p className="text-gray-500  text-[12px] bg-gray-300 rounded">
                                  ONLY PAGE CONTENT
                                </p>
                              </div>
                              <div className="flex items-center">
                                <div className="flex w-full space-x-24">
                                  <div className="bg-gray-300 rounded-md text-green-600 p-1 font-semibold ml-2">
                                    Draft
                                  </div>
                                ...
                                <div className="w-full flex justify-end mr-4 cursor-pointer">
                                  <button
                                    className=" px-6 py-2 block rounded-md border border-gray-400 transition ease-in-out duration-150"
                                    onClick={onToggleModal}
                                  >
                                    Setup Hero Block
                                  </button>
                        ...
                        <div className="bg-white  hover:bg-gray-200 border-b border-b-gray-400">
                          <div className="">
                            <div className="grid grid-cols-2 items-center px-3 py-2">
                              <div className="flex items-center space-x-2">
                                <h5 className="font-semibold">CTA Block</h5>
                                <p className="text-gray-500  text-[12px] bg-gray-300 rounded">
                                  ONLY PAGE CONTENT
                                </p>
                              </div>
                              <div className="flex items-center">
                                ...
                                <div className="w-full flex justify-end mr-4 cursor-pointer">
                                  <button className=" px-6 py-2 block rounded-md border border-gray-400">
                                    Setup CTA Block
                                  </button>
                                </div>
                              </div>
                  ...
                  <div>
                    <div className="overflow-hidden w-full border border-gray-400 rounded-md bg-white">
                      <div className="px-3 py-2">
                        <p className="font-bold">Generated Pages</p>
                        <p>Pages that are auto-generated for your blog.</p>
                      </div>
                      <div className="border-b border-b-gray-400">
                        <div className="grid grid-cols-2 items-center px-3 bg-slate-300">
                          <div>
                        ...
                        <div className="bg-white  hover:bg-gray-200 border-b border-b-gray-400">
                          <div className="">
                            <div className="grid grid-cols-2 items-center px-3 py-2">
                              <div>
                                <div className="flex items-center space-x-2">
                                  <h5 className="font-semibold">Block Index</h5>
                                  <p className="text-gray-500  text-[12px] bg-gray-300 rounded">
                                    ONLY PAGE CONTENT
                                  </p>
                                </div>
                        ...
                        <div className="bg-white  hover:bg-gray-200 border-b border-b-gray-400">
                          <div className="">
                            <div className="grid grid-cols-2 items-center px-3 py-2">
                              <div>
                                <div className="flex items-center space-x-2">
                                  <h5 className="font-semibold">Tags Index</h5>
                                  <p className="text-gray-500  text-[12px] bg-gray-300 rounded">
                                    HOME
                                  </p>
                                </div>
                  ...
                  <div>
                    <div className="overflow-hidden w-full border border-gray-400 rounded-md bg-white">
                      <div className="px-3 py-2">
                        <p className="font-bold">Notion Pages</p>
                        <p>
                          Notion pages that are within your "Pages" database
                        </p>
                      </div>
                      <div className="border-b border-b-gray-400">
                        <div className="grid grid-cols-2 items-center px-3 bg-slate-300">
